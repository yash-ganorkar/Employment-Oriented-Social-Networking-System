...
public class JobTest {
    ...
    public void setUp() {
        ...
        Job job = new Job("Summer Internship, starting from May through August.", "Software Engineering Internship", "Internship", 125000D, new GregorianCalendar(2005,5,7).getTime());
    ...
    public void persistNewJobTest(){
        Job job = new Job("Summer Internship, starting from May through August.", "Software Engineering Internship", "Internship", 125000D, new GregorianCalendar(2010,5,7).getTime());
        ...
        job = new Job("Summer Internship, starting from May through August.", "Software Engineering Internship", "Internship", 145000D, new GregorianCalendar(2002,5,7).getTime());
        entityTransaction.begin();
        entityManager.persist(job);
        entityTransaction.commit();


        job = new Job("Summer Internship, starting from May through August.", "Software Engineering Internship", "Internship", 125000D, new GregorianCalendar(2005,5,7).getTime());
        entityTransaction.begin();
        entityManager.persist(job);
        entityTransaction.commit();
...
//
    ...
    public void updateJob(){
        ...
        Job job =  entityManager.createNamedQuery("Job.fetchAllRecordsByDate", Job.class)
                                         .setParameter("value1", new GregorianCalendar(2002,5,7).getTime())
                                         .getSingleResult();
        ...
        job =  entityManager.createNamedQuery("Job.fetchAllRecordsByDate", Job.class)
                                .setParameter("value1", new GregorianCalendar(2002,5,7).getTime())
                                .getSingleResult();        
        assertNotNull(job);        
    }
//
    ...
    public void validateSalary(){
        ...
        Job job = new Job("Summer Internship, starting from May through August.", "Software Engineering Internship", "Internship", 125000D, new GregorianCalendar(2000,5,7).getTime());
    ...
    public void validateSalaryRainyDay(){
        ...
        Job job = new Job("Summer Internship, starting from May through August.", "Software Engineering Internship", "Internship", 125000.999D, new GregorianCalendar(2000,5,7).getTime());
    ...
    public void tearDown() {
        Job job =  entityManager.createNamedQuery("Job.fetchAllRecordsByDate", Job.class)
                                         .setParameter("value1", new GregorianCalendar(2005,5,7).getTime())
                                         .getSingleResult();
