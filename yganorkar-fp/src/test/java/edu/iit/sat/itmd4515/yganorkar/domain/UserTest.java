...
public class UserTest {
    ...
    public void setUp() {
        ...
        User user = new User("bruce", "brucewayne", "brucewayne@waynetech.com", "Bruce", "Wayne", new GregorianCalendar(2010,5,7).getTime());
    ...
    public void persistNewUserTest(){
        ...
        user = new User("username", "password", "email@gmail.com", "firstName", "lastName", new GregorianCalendar(2010,5,7).getTime());
        entityTransaction.begin();
        entityManager.persist(user);
        entityTransaction.commit();
        ...
        //rainy day test
        user = new User("bruce", "brucewayne", "brucewayne@waynetech.com", "Bruce", "Wayne", new GregorianCalendar(2010,5,7).getTime());
        entityTransaction.begin();
        entityManager.persist(user);
        entityTransaction.commit();
    ...
    */
    ...
    /**
     * Bean validation checking for length of password in User entity. Sunny day test case.
     */        
    @Test
    ...
    /**
     * Bean validation checking for length of password in User entity. Rainy day test case.
     */        
    
    @Test
    public void validatePasswordRainyDay(){

        User user = new User("", "iamsupn", "clarkkent@dailyplanet.com", "Clark", "Kent", new GregorianCalendar(2014,5,7).getTime());        
        Set<ConstraintViolation<User>> violations = validator.validate(user);
    ...
    /**
     * Testing OneToOne Bi-directional relationship between User and UserProfile entity.
     * User being the non-owning side or inverse side. 
     */    
    
    
    @Test
    public void testOneToOneBiDirectionalRelationship(){
        User user = entityManager.createNamedQuery("User.fetchParticularRecordByEmail", User.class)
                                 .setParameter("email", "email@gmail.com")
                                 .getSingleResult();

        UserProfile userProfile = new UserProfile("streetAddress", "city", "state", "country", 60616, new GregorianCalendar(2014,5,7).getTime(), user.getEmail());
        ...
        assertEquals(user.getEmail(),user.getUserProfile().getEmailId());
    }

    /**
     * Testing OneToMany relationship between User and Post entity.
     * User being the non-owning side or inverse side.
     */    
    ...
    public void testOneToManyUserPostRelationship(){
        ...
        Query query = entityManager.createQuery("SELECT p FROM Post p where p.user.userId = :value1").setParameter("value1", user.getUserId());
    ...
    /**
     * Testing OneToMany relationship between User and Comment entity.
     * User being the non-owning side or inverse side.
     */    
    ...
    /**
     * Testing OneToMany relationship between User and Job entity.
     * User being the non-owning side or inverse side.
     */    
    ...
    /**
     * Testing OneToMany relationship between User and Company entity.
     * User being the non-owning side or inverse side.
     */    
